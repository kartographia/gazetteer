...
ALTER TABLE GAZETTER.PLACE_NAME ADD FOREIGN KEY (PLACE_ID) REFERENCES GAZETTER.PLACE(ID)
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
CREATE INDEX IDX_PLACE_NAME_PLACE ON GAZETTER.PLACE_NAME(PLACE_ID);
...
CREATE TRIGGER TGR_PLACE_NAME_UPDATE BEFORE INSERT OR UPDATE ON GAZETTER.PLACE_NAME
    FOR EACH ROW EXECUTE PROCEDURE last_modified();
