...
CREATE TABLE GAZETTER.PLACE_NAME (
    PLACE_ID BIGINT NOT NULL,
    NAME_ID BIGINT NOT NULL,
    CONSTRAINT FK_PLACE_NAME FOREIGN KEY (PLACE_ID) REFERENCES GAZETTER.PLACE(ID)
        ON DELETE CASCADE ON UPDATE NO ACTION
);

ALTER TABLE GAZETTER.PLACE_NAME ADD FOREIGN KEY (NAME_ID) REFERENCES GAZETTER.NAME(ID)
    ON DELETE CASCADE ON UPDATE NO ACTION;

CREATE INDEX IDX_PLACE_NAME_PLACE_ID ON GAZETTER.PLACE_NAME(PLACE_ID);
CREATE INDEX IDX_PLACE_NAME_NAME_ID ON GAZETTER.PLACE_NAME(NAME_ID);
